...
object RecipePrompt {
    ...
    val SYSTEM_PROMPT = """
        ...
        3. ingredients: "재료명 + 종이컵/스푼/개수" 형태
            - 'g', 'ml' 단위를 쓰지 말 것.
            - 가루/액체: 무조건 '밥숟가락' 혹은 '종이컵'으로 표현 (예: 간장 2스푼, 물 1/2컵)
            - 덩어리 재료: '개수' 혹은 '등분'으로 표현 (예: 양파 1/2개, 마늘 3알)
            - 애매한 재료: '주먹'이나 '마디'로 표현 (예: 주꾸미 두 주먹, 생강 한 마디)
            - 요리 저울이 없는 자취생이 봐도 바로 양을 알 수 있게 최대한 생활 언어로 쓸 것.
